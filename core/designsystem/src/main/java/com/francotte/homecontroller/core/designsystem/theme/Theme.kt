...
fun HomeControllerTheme(
    ...
    // Palette de marque fixe par défaut ; le dynamique reste possible mais désactivé.
    ...
    // Material 3 Expressive n'est public qu'en material3 1.5.0-alpha ; on reste sur le
    // MaterialTheme stable (1.4.0) en portant la nouvelle identité (couleurs, typo, formes).
    // On pourra passer à MaterialExpressiveTheme quand 1.5.0 sera stable.
    MaterialTheme(
